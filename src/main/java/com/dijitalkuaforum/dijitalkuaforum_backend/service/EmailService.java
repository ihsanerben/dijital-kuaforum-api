...
public class EmailService {
    ...
    public void thereIsAAppointment(Customer customer, Randevu randevu) {
        String subject = "Merhaba Ridvan, bir randevu talebin var.";
        String text = "\nMusteri Adi: " + customer.getFullName() + ",\n\n" +
                "Randevu talebi olusturmustur ve senden onay beklemektedir.\n\n" +
                "Tarih: " + randevu.getStartTime() + "\n";

        sendSimpleEmail(fromEmail, subject, text);
    }
