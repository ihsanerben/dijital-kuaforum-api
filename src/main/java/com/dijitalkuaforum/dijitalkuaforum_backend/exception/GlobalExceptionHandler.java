...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
        return new ResponseEntity<>(new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), "GENEL BIR HATA USTA."), HttpStatus.INTERNAL_SERVER_ERROR
        );
    }

    @ExceptionHandler(UserDidntRegister.class)
    public ResponseEntity<ErrorResponse> handleUserDidntRegister(UserDidntRegister ex) {
